document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderizarTickets(tickets) {
        ...
        if (tickets.length === 0) {
            tableBody.innerHTML = '<tr><td colspan="7" style="text-align: center;">No hay tickets en el historial</td></tr>';
            return;
        }
    ...
    console.log("Panel de Historial de Tickets (Técnico) inicializado.");
});